 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnableUserCalibrationEventsML>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result enableUserCalibrationEventsML (
    const UserCalibrationEnableEventsInfoML& enableInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrEnableUserCalibrationEventsML enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void enableUserCalibrationEventsML (
        const UserCalibrationEnableEventsInfoML& enableInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createBodyTrackerFB (
    const BodyTrackerCreateInfoFB& createInfo, BodyTrackerFB& bodyTracker, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<BodyTrackerFB> createBodyTrackerFB (
        const BodyTrackerCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    BodyTrackerFB createBodyTrackerFB (
        const BodyTrackerCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<BodyTrackerFB, impl::RemoveRefConst<Dispatch>>> createBodyTrackerUniqueFB (
        const BodyTrackerCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
...
Result setMarkerTrackingPredictionVARJO (
    uint64_t markerId, XrBool32 enable, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateSpaceFromCoordinateFrameUIDML>
 * 
...
Result createSpaceFromCoordinateFrameUIDML (
    const CoordinateSpaceCreateInfoML& createInfo, Space& space, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<Space> createSpaceFromCoordinateFrameUIDML (
        const CoordinateSpaceCreateInfoML& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    Space createSpaceFromCoordinateFrameUIDML (
        const CoordinateSpaceCreateInfoML& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<Space, impl::RemoveRefConst<Dispatch>>> createSpaceFromCoordinateFrameUIDUniqueML (
        const CoordinateSpaceCreateInfoML& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result shareSpacesFB (
    const SpaceShareInfoFB& info, AsyncRequestIdFB requestId, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    AsyncRequestIdFB shareSpacesFB (
        const SpaceShareInfoFB& info, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrRequestSceneCaptureFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result requestSceneCaptureFB (
    const SceneCaptureRequestInfoFB& info, AsyncRequestIdFB requestId, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<AsyncRequestIdFB> requestSceneCaptureFB (
        const SceneCaptureRequestInfoFB& info, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    AsyncRequestIdFB requestSceneCaptureFB (
        const SceneCaptureRequestInfoFB& info, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetFoveationEyeTrackedStateMETA>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getFoveationEyeTrackedStateMETA (
    FoveationEyeTrackedStateMETA& foveationState, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createFaceTrackerFB (
    const FaceTrackerCreateInfoFB& createInfo, FaceTrackerFB& faceTracker, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<FaceTrackerFB> createFaceTrackerFB (
        const FaceTrackerCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    FaceTrackerFB createFaceTrackerFB (
        const FaceTrackerCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<FaceTrackerFB, impl::RemoveRefConst<Dispatch>>> createFaceTrackerUniqueFB (
        const FaceTrackerCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createEyeTrackerFB (
    const EyeTrackerCreateInfoFB& createInfo, EyeTrackerFB& eyeTracker, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<EyeTrackerFB> createEyeTrackerFB (
        const EyeTrackerCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    EyeTrackerFB createEyeTrackerFB (
        const EyeTrackerCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetDeviceSampleRateFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getDeviceSampleRateFB (
    const HapticActionInfo& hapticActionInfo, XrDevicePcmSampleRateGetInfoFB* deviceSampleRate, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<DevicePcmSampleRateGetInfoFB> getDeviceSampleRateFB (
        const HapticActionInfo& hapticActionInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    DevicePcmSampleRateGetInfoFB getDeviceSampleRateFB (
        const HapticActionInfo& hapticActionInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetPassthroughPreferencesMETA>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getPassthroughPreferencesMETA (
    PassthroughPreferencesMETA& preferences, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateVirtualKeyboardMETA>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createVirtualKeyboardMETA (
    const VirtualKeyboardCreateInfoMETA& createInfo, VirtualKeyboardMETA& keyboard, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<VirtualKeyboardMETA> createVirtualKeyboardMETA (
        const VirtualKeyboardCreateInfoMETA& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    VirtualKeyboardMETA createVirtualKeyboardMETA (
        const VirtualKeyboardCreateInfoMETA& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<VirtualKeyboardMETA, impl::RemoveRefConst<Dispatch>>> createVirtualKeyboardUniqueMETA (
        const VirtualKeyboardCreateInfoMETA& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateVirtualKeyboardSpaceMETA>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createVirtualKeyboardSpaceMETA (
    VirtualKeyboardMETA keyboard, const VirtualKeyboardSpaceCreateInfoMETA& createInfo, Space& keyboardSpace, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<Space> createVirtualKeyboardSpaceMETA (
        VirtualKeyboardMETA keyboard, const VirtualKeyboardSpaceCreateInfoMETA& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    Space createVirtualKeyboardSpaceMETA (
        VirtualKeyboardMETA keyboard, const VirtualKeyboardSpaceCreateInfoMETA& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<Space, impl::RemoveRefConst<Dispatch>>> createVirtualKeyboardSpaceUniqueMETA (
        VirtualKeyboardMETA keyboard, const VirtualKeyboardSpaceCreateInfoMETA& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateExternalCamerasOCULUS>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result enumerateExternalCamerasOCULUS (
    uint32_t cameraCapacityInput, uint32_t* cameraCountOutput, XrExternalCameraOCULUS* cameras, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<ExternalCameraOCULUS>, typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<ExternalCameraOCULUS>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<ExternalCameraOCULUS, Allocator>> enumerateExternalCamerasToVectorOCULUS (
        Allocator const& vectorAllocator, Dispatch&& d) const;
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result saveSpaceListFB (
    const SpaceListSaveInfoFB& info, AsyncRequestIdFB requestId, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    AsyncRequestIdFB saveSpaceListFB (
        const SpaceListSaveInfoFB& info, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createSpaceUserFB (
    const SpaceUserCreateInfoFB& info, SpaceUserFB& user, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSetTrackingOptimizationSettingsHintQCOM>
 * 
...
Result setTrackingOptimizationSettingsHintQCOM (
    TrackingOptimizationSettingsDomainQCOM domain, TrackingOptimizationSettingsHintQCOM hint, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSetTrackingOptimizationSettingsHintQCOM enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreatePlaneDetectorEXT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createPlaneDetectorEXT (
    const PlaneDetectorCreateInfoEXT& createInfo, PlaneDetectorEXT& planeDetector, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<PlaneDetectorEXT> createPlaneDetectorEXT (
        const PlaneDetectorCreateInfoEXT& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    PlaneDetectorEXT createPlaneDetectorEXT (
        const PlaneDetectorCreateInfoEXT& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<PlaneDetectorEXT, impl::RemoveRefConst<Dispatch>>> createPlaneDetectorUniqueEXT (
        const PlaneDetectorCreateInfoEXT& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrApplyForceFeedbackCurlMNDX>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result applyForceFeedbackCurlMNDX (
    const ForceFeedbackCurlApplyLocationsMNDX& locations, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
/*!
 * @brief xrApplyForceFeedbackCurlMNDX enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Throws an appropriate exception on failure if `OPENXR_HPP_NO_EXCEPTIONS` is not defined.
 * 
 * @returns Result (which may be Result::Success, Result::SessionNotFocused, or an error code if asserts are not active and exceptions are disabled)
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrBodyTrackerFB get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrDestroyBodyTrackerFB>
 * 
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroyBodyTrackerFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result locateBodyJointsFB (
    const BodyJointsLocateInfoFB& locateInfo, BodyJointLocationsFB& locations, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrLocateBodyJointsFB enhanced wrapper.
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * @returns a ResultValue tuple containing:
 * - Result (which may be Result::Success, or an error code if asserts are not active )
 * - the output of type BodyJointLocationsFB
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrLocateBodyJointsFB>
 * 
 * @xrentity{xrLocateBodyJointsFB}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<BodyJointLocationsFB> locateBodyJointsFB (
        const BodyJointsLocateInfoFB& locateInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * Throws an appropriate exception on failure.
 * 
 * @returns the output of type BodyJointLocationsFB
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrLocateBodyJointsFB>
 * 
 * @xrentity{xrLocateBodyJointsFB}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    BodyJointLocationsFB locateBodyJointsFB (
        const BodyJointsLocateInfoFB& locateInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getBodySkeletonFB (
    BodySkeletonFB& skeleton, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrGetBodySkeletonFB enhanced wrapper.
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * @returns a ResultValue tuple containing:
 * - Result (which may be Result::Success, or an error code if asserts are not active )
 * - the output of type BodySkeletonFB
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetBodySkeletonFB>
 * 
 * @xrentity{xrGetBodySkeletonFB}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<BodySkeletonFB> getBodySkeletonFB (
        Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * Throws an appropriate exception on failure.
 * 
 * @returns the output of type BodySkeletonFB
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetBodySkeletonFB>
 * 
 * @xrentity{xrGetBodySkeletonFB}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    BodySkeletonFB getBodySkeletonFB (
        Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
...
//! @}
 ...
 static_assert(sizeof(XrBodyTrackerFB) == sizeof(BodyTrackerFB), "Original type and wrapper have different size!"); 
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrBodyTrackerFB get(BodyTrackerFB const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrBodyTrackerFB handle in a BodyTrackerFB (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates BodyTrackerFB
 */
static OPENXR_HPP_INLINE XrBodyTrackerFB *put(BodyTrackerFB &h, bool clear = true) noexcept { return h.put(clear); }

//! @brief `<` comparison between BodyTrackerFB values.
//! @relates BodyTrackerFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(BodyTrackerFB const& lhs, BodyTrackerFB const& rhs) noexcept {
    return lhs.get()<rhs.get();
}
//! @brief `>` comparison between BodyTrackerFB values.
//! @relates BodyTrackerFB
...
//! @relates BodyTrackerFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(BodyTrackerFB const& lhs, XrBodyTrackerFB rhs) noexcept {
    return lhs.get()<rhs;
}
//! @brief `<` comparison between raw XrBodyTrackerFB and BodyTrackerFB.
//! @relates BodyTrackerFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrBodyTrackerFB lhs, BodyTrackerFB const& rhs) noexcept {
    return lhs<rhs.get();
}
//! @brief `>` comparison between BodyTrackerFB and raw XrBodyTrackerFB.
//! @relates BodyTrackerFB
 ...
 * @relates BodyTrackerFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(BodyTrackerFB const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() == XR_NULL_HANDLE;
}
/*!
 ...
 * @relates BodyTrackerFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, BodyTrackerFB const &rhs) noexcept {
    return rhs.get() == XR_NULL_HANDLE;
}
/*!
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreatePassthroughColorLutMETA>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createPassthroughColorLutMETA (
    const PassthroughColorLutCreateInfoMETA& createInfo, PassthroughColorLutMETA& colorLut, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<PassthroughColorLutMETA> createPassthroughColorLutMETA (
        const PassthroughColorLutCreateInfoMETA& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<PassthroughColorLutMETA, impl::RemoveRefConst<Dispatch>>> createPassthroughColorLutUniqueMETA (
        const PassthroughColorLutCreateInfoMETA& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    UniqueHandle<PassthroughColorLutMETA, impl::RemoveRefConst<Dispatch>> createPassthroughColorLutUniqueMETA (
        const PassthroughColorLutCreateInfoMETA& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetSceneMarkerRawDataMSFT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getSceneMarkerRawDataMSFT (
    const UuidMSFT& markerId, uint32_t bufferCapacityInput, uint32_t* bufferCountOutput, uint8_t* buffer, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<uint8_t>, typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<uint8_t>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<uint8_t, Allocator>> getSceneMarkerRawDataToVectorMSFT (
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetSceneMarkerDecodedStringMSFT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getSceneMarkerDecodedStringMSFT (
    const UuidMSFT& markerId, uint32_t bufferCapacityInput, uint32_t* bufferCountOutput, char* buffer, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @returns a ResultValue tuple containing:
 * - Result (which may be Result::Success, Result::SceneMarkerDataNotStringMSFT, or an error code if asserts are not active and exceptions are disabled)
 * - the output string
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetSceneMarkerDecodedStringMSFT>
 * 
 ...
 * 
 * @returns a ResultValue tuple containing:
 * - Result (which may be Result::Success, Result::SceneMarkerDataNotStringMSFT, or an error code if asserts are not active )
 * - the output string
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetSceneMarkerDecodedStringMSFT>
 * 
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrSpaceUserFB get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getSpaceUserIdFB (
    XrSpaceUserIdFB* userId, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    SpaceUserIdFB getSpaceUserIdFB (
        Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroySpaceUserFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
...
//! @}
 ...
 static_assert(sizeof(XrSpaceUserFB) == sizeof(SpaceUserFB), "Original type and wrapper have different size!"); 
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrSpaceUserFB get(SpaceUserFB const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrSpaceUserFB handle in a SpaceUserFB (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates SpaceUserFB
 */
static OPENXR_HPP_INLINE XrSpaceUserFB *put(SpaceUserFB &h, bool clear = true) noexcept { return h.put(clear); }

//! @brief `<` comparison between SpaceUserFB values.
//! @relates SpaceUserFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(SpaceUserFB const& lhs, SpaceUserFB const& rhs) noexcept {
    return lhs.get()<rhs.get();
}
//! @brief `>` comparison between SpaceUserFB values.
//! @relates SpaceUserFB
...
//! @relates SpaceUserFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(SpaceUserFB const& lhs, XrSpaceUserFB rhs) noexcept {
    return lhs.get()<rhs;
}
//! @brief `<` comparison between raw XrSpaceUserFB and SpaceUserFB.
//! @relates SpaceUserFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrSpaceUserFB lhs, SpaceUserFB const& rhs) noexcept {
    return lhs<rhs.get();
}
//! @brief `>` comparison between SpaceUserFB and raw XrSpaceUserFB.
//! @relates SpaceUserFB
 ...
 * @relates SpaceUserFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(SpaceUserFB const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() == XR_NULL_HANDLE;
}
/*!
 ...
 * @relates SpaceUserFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, SpaceUserFB const &rhs) noexcept {
    return rhs.get() == XR_NULL_HANDLE;
}
/*!
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrFaceTrackerFB get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrDestroyFaceTrackerFB>
 * 
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroyFaceTrackerFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetFaceExpressionWeightsFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getFaceExpressionWeightsFB (
    const FaceExpressionInfoFB& expressionInfo, FaceExpressionWeightsFB& expressionWeights, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrGetFaceExpressionWeightsFB enhanced wrapper.
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * @returns a ResultValue tuple containing:
 * - Result (which may be Result::Success, or an error code if asserts are not active )
 * - the output of type FaceExpressionWeightsFB
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetFaceExpressionWeightsFB>
 * 
 * @xrentity{xrGetFaceExpressionWeightsFB}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<FaceExpressionWeightsFB> getFaceExpressionWeightsFB (
        const FaceExpressionInfoFB& expressionInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * Throws an appropriate exception on failure.
 * 
 * @returns the output of type FaceExpressionWeightsFB
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetFaceExpressionWeightsFB>
 * 
 * @xrentity{xrGetFaceExpressionWeightsFB}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    FaceExpressionWeightsFB getFaceExpressionWeightsFB (
        const FaceExpressionInfoFB& expressionInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
...
//! @}
 ...
 static_assert(sizeof(XrFaceTrackerFB) == sizeof(FaceTrackerFB), "Original type and wrapper have different size!"); 
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrFaceTrackerFB get(FaceTrackerFB const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrFaceTrackerFB handle in a FaceTrackerFB (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates FaceTrackerFB
 */
static OPENXR_HPP_INLINE XrFaceTrackerFB *put(FaceTrackerFB &h, bool clear = true) noexcept { return h.put(clear); }

//! @brief `<` comparison between FaceTrackerFB values.
//! @relates FaceTrackerFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(FaceTrackerFB const& lhs, FaceTrackerFB const& rhs) noexcept {
    return lhs.get()<rhs.get();
}
//! @brief `>` comparison between FaceTrackerFB values.
//! @relates FaceTrackerFB
...
//! @relates FaceTrackerFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(FaceTrackerFB const& lhs, XrFaceTrackerFB rhs) noexcept {
    return lhs.get()<rhs;
}
//! @brief `<` comparison between raw XrFaceTrackerFB and FaceTrackerFB.
//! @relates FaceTrackerFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrFaceTrackerFB lhs, FaceTrackerFB const& rhs) noexcept {
    return lhs<rhs.get();
}
//! @brief `>` comparison between FaceTrackerFB and raw XrFaceTrackerFB.
//! @relates FaceTrackerFB
 ...
 * @relates FaceTrackerFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(FaceTrackerFB const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() == XR_NULL_HANDLE;
}
/*!
 ...
 * @relates FaceTrackerFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, FaceTrackerFB const &rhs) noexcept {
    return rhs.get() == XR_NULL_HANDLE;
}
/*!
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrEyeTrackerFB get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroyEyeTrackerFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getEyeGazesFB (
    const EyeGazesInfoFB& gazeInfo, EyeGazesFB& eyeGazes, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<EyeGazesFB> getEyeGazesFB (
        const EyeGazesInfoFB& gazeInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
...
//! @}
 ...
 static_assert(sizeof(XrEyeTrackerFB) == sizeof(EyeTrackerFB), "Original type and wrapper have different size!"); 
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrEyeTrackerFB get(EyeTrackerFB const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrEyeTrackerFB handle in a EyeTrackerFB (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates EyeTrackerFB
 */
static OPENXR_HPP_INLINE XrEyeTrackerFB *put(EyeTrackerFB &h, bool clear = true) noexcept { return h.put(clear); }

//! @brief `<` comparison between EyeTrackerFB values.
//! @relates EyeTrackerFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(EyeTrackerFB const& lhs, EyeTrackerFB const& rhs) noexcept {
    return lhs.get()<rhs.get();
}
//! @brief `>` comparison between EyeTrackerFB values.
//! @relates EyeTrackerFB
...
//! @relates EyeTrackerFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(EyeTrackerFB const& lhs, XrEyeTrackerFB rhs) noexcept {
    return lhs.get()<rhs;
}
//! @brief `<` comparison between raw XrEyeTrackerFB and EyeTrackerFB.
//! @relates EyeTrackerFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrEyeTrackerFB lhs, EyeTrackerFB const& rhs) noexcept {
    return lhs<rhs.get();
}
//! @brief `>` comparison between EyeTrackerFB and raw XrEyeTrackerFB.
//! @relates EyeTrackerFB
 ...
 * @relates EyeTrackerFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(EyeTrackerFB const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() == XR_NULL_HANDLE;
}
/*!
 ...
 * @relates EyeTrackerFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, EyeTrackerFB const &rhs) noexcept {
    return rhs.get() == XR_NULL_HANDLE;
}
/*!
...
//! Constructor from nullptr - creates empty/null handle.
OPENXR_HPP_CONSTEXPR VirtualKeyboardMETA (std::nullptr_t /* unused */) noexcept : val_(XR_NULL_HANDLE) {}
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrVirtualKeyboardMETA get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrDestroyVirtualKeyboardMETA>
 * 
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroyVirtualKeyboardMETA enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSuggestVirtualKeyboardLocationMETA>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result suggestVirtualKeyboardLocationMETA (
    const VirtualKeyboardLocationInfoMETA& locationInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSuggestVirtualKeyboardLocationMETA enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void suggestVirtualKeyboardLocationMETA (
        const VirtualKeyboardLocationInfoMETA& locationInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetVirtualKeyboardScaleMETA>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getVirtualKeyboardScaleMETA (
    float* scale, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    float getVirtualKeyboardScaleMETA (
        Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSetVirtualKeyboardModelVisibilityMETA>
 * 
...
Result setVirtualKeyboardModelVisibilityMETA (
    const VirtualKeyboardModelVisibilitySetInfoMETA& modelVisibility, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSetVirtualKeyboardModelVisibilityMETA enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetVirtualKeyboardModelAnimationStatesMETA>
 * 
...
Result getVirtualKeyboardModelAnimationStatesMETA (
    VirtualKeyboardModelAnimationStatesMETA& animationStates, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrGetVirtualKeyboardModelAnimationStatesMETA enhanced wrapper.
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * @returns a ResultValue tuple containing:
 * - Result (which may be Result::Success, or an error code if asserts are not active )
 * - the output of type VirtualKeyboardModelAnimationStatesMETA
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetVirtualKeyboardModelAnimationStatesMETA>
 * 
 * @xrentity{xrGetVirtualKeyboardModelAnimationStatesMETA}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<VirtualKeyboardModelAnimationStatesMETA> getVirtualKeyboardModelAnimationStatesMETA (
        Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * Throws an appropriate exception on failure.
 * 
 * @returns the output of type VirtualKeyboardModelAnimationStatesMETA
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetVirtualKeyboardModelAnimationStatesMETA>
 * 
 * @xrentity{xrGetVirtualKeyboardModelAnimationStatesMETA}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    VirtualKeyboardModelAnimationStatesMETA getVirtualKeyboardModelAnimationStatesMETA (
        Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetVirtualKeyboardDirtyTexturesMETA>
 * 
...
Result getVirtualKeyboardDirtyTexturesMETA (
    uint32_t textureIdCapacityInput, uint32_t* textureIdCountOutput, uint64_t* textureIds, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<uint64_t>, typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<uint64_t>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<uint64_t, Allocator>> getVirtualKeyboardDirtyTexturesToVectorMETA (
        Allocator const& vectorAllocator, Dispatch&& d) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetVirtualKeyboardTextureDataMETA>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getVirtualKeyboardTextureDataMETA (
    uint64_t textureId, VirtualKeyboardTextureDataMETA& textureData, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrGetVirtualKeyboardTextureDataMETA enhanced wrapper.
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * @returns a ResultValue tuple containing:
 * - Result (which may be Result::Success, or an error code if asserts are not active )
 * - the output of type VirtualKeyboardTextureDataMETA
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetVirtualKeyboardTextureDataMETA>
 * 
 * @xrentity{xrGetVirtualKeyboardTextureDataMETA}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<VirtualKeyboardTextureDataMETA> getVirtualKeyboardTextureDataMETA (
        uint64_t textureId, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * Throws an appropriate exception on failure.
 * 
 * @returns the output of type VirtualKeyboardTextureDataMETA
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetVirtualKeyboardTextureDataMETA>
 * 
 * @xrentity{xrGetVirtualKeyboardTextureDataMETA}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    VirtualKeyboardTextureDataMETA getVirtualKeyboardTextureDataMETA (
        uint64_t textureId, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSendVirtualKeyboardInputMETA>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result sendVirtualKeyboardInputMETA (
    const VirtualKeyboardInputInfoMETA& info, Posef& interactorRootPose, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<Posef> sendVirtualKeyboardInputMETA (
        const VirtualKeyboardInputInfoMETA& info, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    Posef sendVirtualKeyboardInputMETA (
        const VirtualKeyboardInputInfoMETA& info, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrChangeVirtualKeyboardTextContextMETA>
 * 
...
Result changeVirtualKeyboardTextContextMETA (
    const VirtualKeyboardTextContextChangeInfoMETA& changeInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrChangeVirtualKeyboardTextContextMETA enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
...
//! @}
 ...
 static_assert(sizeof(XrVirtualKeyboardMETA) == sizeof(VirtualKeyboardMETA), "Original type and wrapper have different size!"); 
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrVirtualKeyboardMETA get(VirtualKeyboardMETA const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrVirtualKeyboardMETA handle in a VirtualKeyboardMETA (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates VirtualKeyboardMETA
 */
static OPENXR_HPP_INLINE XrVirtualKeyboardMETA *put(VirtualKeyboardMETA &h, bool clear = true) noexcept { return h.put(clear); }

//! @brief `<` comparison between VirtualKeyboardMETA values.
//! @relates VirtualKeyboardMETA
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(VirtualKeyboardMETA const& lhs, VirtualKeyboardMETA const& rhs) noexcept {
    return lhs.get()<rhs.get();
}
//! @brief `>` comparison between VirtualKeyboardMETA values.
//! @relates VirtualKeyboardMETA
...
//! @relates VirtualKeyboardMETA
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(VirtualKeyboardMETA const& lhs, XrVirtualKeyboardMETA rhs) noexcept {
    return lhs.get()<rhs;
}
//! @brief `<` comparison between raw XrVirtualKeyboardMETA and VirtualKeyboardMETA.
//! @relates VirtualKeyboardMETA
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrVirtualKeyboardMETA lhs, VirtualKeyboardMETA const& rhs) noexcept {
    return lhs<rhs.get();
}
//! @brief `>` comparison between VirtualKeyboardMETA and raw XrVirtualKeyboardMETA.
//! @relates VirtualKeyboardMETA
 ...
 * @relates VirtualKeyboardMETA
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(VirtualKeyboardMETA const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() == XR_NULL_HANDLE;
}
/*!
 ...
 * @relates VirtualKeyboardMETA
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, VirtualKeyboardMETA const &rhs) noexcept {
    return rhs.get() == XR_NULL_HANDLE;
}
/*!
 * @brief Inequality comparison between VirtualKeyboardMETA and nullptr: true if the handle is not null.
 * @relates VirtualKeyboardMETA
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator!=(VirtualKeyboardMETA const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() != XR_NULL_HANDLE;
...
/*!
 * @brief Inequality comparison between nullptr and VirtualKeyboardMETA: true if the handle is not null.
 * @relates VirtualKeyboardMETA
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator!=(std::nullptr_t /* unused */, VirtualKeyboardMETA const &rhs) noexcept {
    return rhs.get() != XR_NULL_HANDLE;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrPassthroughColorLutMETA>
 * 
 ...
 * Explicit on 32-bit platforms by default unless `OPENXR_HPP_TYPESAFE_CONVERSION` is defined.
 */
OPENXR_HPP_TYPESAFE_EXPLICIT PassthroughColorLutMETA (RawHandleType handle) noexcept : val_(handle) {}
//! Constructor from nullptr - creates empty/null handle.
OPENXR_HPP_CONSTEXPR PassthroughColorLutMETA (std::nullptr_t /* unused */) noexcept : val_(XR_NULL_HANDLE) {}
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrPassthroughColorLutMETA get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrDestroyPassthroughColorLutMETA>
 * 
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroyPassthroughColorLutMETA enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrUpdatePassthroughColorLutMETA>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result updatePassthroughColorLutMETA (
    const PassthroughColorLutUpdateInfoMETA& updateInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrUpdatePassthroughColorLutMETA enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void updatePassthroughColorLutMETA (
        const PassthroughColorLutUpdateInfoMETA& updateInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
...
//! @}
 ...
 static_assert(sizeof(XrPassthroughColorLutMETA) == sizeof(PassthroughColorLutMETA), "Original type and wrapper have different size!"); 

/*!
 * @brief Free function for getting the raw XrPassthroughColorLutMETA from an PassthroughColorLutMETA value.
 * 
 * @found_by_adl
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrPassthroughColorLutMETA get(PassthroughColorLutMETA const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrPassthroughColorLutMETA handle in a PassthroughColorLutMETA (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates PassthroughColorLutMETA
 */
static OPENXR_HPP_INLINE XrPassthroughColorLutMETA *put(PassthroughColorLutMETA &h, bool clear = true) noexcept { return h.put(clear); }

//! @brief `<` comparison between PassthroughColorLutMETA values.
//! @relates PassthroughColorLutMETA
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(PassthroughColorLutMETA const& lhs, PassthroughColorLutMETA const& rhs) noexcept {
    return lhs.get()<rhs.get();
}
//! @brief `>` comparison between PassthroughColorLutMETA values.
//! @relates PassthroughColorLutMETA
...
//! @relates PassthroughColorLutMETA
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(PassthroughColorLutMETA const& lhs, XrPassthroughColorLutMETA rhs) noexcept {
    return lhs.get()<rhs;
}
//! @brief `<` comparison between raw XrPassthroughColorLutMETA and PassthroughColorLutMETA.
//! @relates PassthroughColorLutMETA
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrPassthroughColorLutMETA lhs, PassthroughColorLutMETA const& rhs) noexcept {
    return lhs<rhs.get();
}
//! @brief `>` comparison between PassthroughColorLutMETA and raw XrPassthroughColorLutMETA.
//! @relates PassthroughColorLutMETA
...
/*!
 * @brief Equality comparison between PassthroughColorLutMETA and nullptr: true if the handle is null.
 * @relates PassthroughColorLutMETA
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(PassthroughColorLutMETA const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() == XR_NULL_HANDLE;
}
/*!
 * @brief Equality comparison between nullptr and PassthroughColorLutMETA: true if the handle is null.
 * @relates PassthroughColorLutMETA
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, PassthroughColorLutMETA const &rhs) noexcept {
    return rhs.get() == XR_NULL_HANDLE;
}
/*!
 * @brief Inequality comparison between PassthroughColorLutMETA and nullptr: true if the handle is not null.
 * @relates PassthroughColorLutMETA
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator!=(PassthroughColorLutMETA const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() != XR_NULL_HANDLE;
...
/*!
 * @brief Inequality comparison between nullptr and PassthroughColorLutMETA: true if the handle is not null.
 * @relates PassthroughColorLutMETA
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator!=(std::nullptr_t /* unused */, PassthroughColorLutMETA const &rhs) noexcept {
    return rhs.get() != XR_NULL_HANDLE;
...
//! Constructor from nullptr - creates empty/null handle.
OPENXR_HPP_CONSTEXPR PlaneDetectorEXT (std::nullptr_t /* unused */) noexcept : val_(XR_NULL_HANDLE) {}
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrPlaneDetectorEXT get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrDestroyPlaneDetectorEXT>
 * 
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroyPlaneDetectorEXT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrBeginPlaneDetectionEXT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result beginPlaneDetectionEXT (
    const PlaneDetectorBeginInfoEXT& beginInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrBeginPlaneDetectionEXT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetPlaneDetectionStateEXT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getPlaneDetectionStateEXT (
    PlaneDetectionStateEXT& state, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetPlaneDetectionsEXT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getPlaneDetectionsEXT (
    const PlaneDetectorGetInfoEXT& info, PlaneDetectorLocationsEXT& locations, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrGetPlaneDetectionsEXT enhanced wrapper.
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * @returns a ResultValue tuple containing:
 * - Result (which may be Result::Success, or an error code if asserts are not active )
 * - the output of type PlaneDetectorLocationsEXT
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetPlaneDetectionsEXT>
 * 
 * @xrentity{xrGetPlaneDetectionsEXT}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<PlaneDetectorLocationsEXT> getPlaneDetectionsEXT (
        const PlaneDetectorGetInfoEXT& info, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * Throws an appropriate exception on failure.
 * 
 * @returns the output of type PlaneDetectorLocationsEXT
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetPlaneDetectionsEXT>
 * 
 * @xrentity{xrGetPlaneDetectionsEXT}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    PlaneDetectorLocationsEXT getPlaneDetectionsEXT (
        const PlaneDetectorGetInfoEXT& info, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetPlanePolygonBufferEXT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getPlanePolygonBufferEXT (
    uint64_t planeId, uint32_t polygonBufferIndex, PlaneDetectorPolygonBufferEXT& polygonBuffer, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrGetPlanePolygonBufferEXT enhanced wrapper.
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * @returns a ResultValue tuple containing:
 * - Result (which may be Result::Success, or an error code if asserts are not active )
 * - the output of type PlaneDetectorPolygonBufferEXT
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetPlanePolygonBufferEXT>
 * 
 * @xrentity{xrGetPlanePolygonBufferEXT}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<PlaneDetectorPolygonBufferEXT> getPlanePolygonBufferEXT (
        uint64_t planeId, uint32_t polygonBufferIndex, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * Throws an appropriate exception on failure.
 * 
 * @returns the output of type PlaneDetectorPolygonBufferEXT
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetPlanePolygonBufferEXT>
 * 
 * @xrentity{xrGetPlanePolygonBufferEXT}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    PlaneDetectorPolygonBufferEXT getPlanePolygonBufferEXT (
        uint64_t planeId, uint32_t polygonBufferIndex, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
...
//! @}
 ...
 static_assert(sizeof(XrPlaneDetectorEXT) == sizeof(PlaneDetectorEXT), "Original type and wrapper have different size!"); 
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrPlaneDetectorEXT get(PlaneDetectorEXT const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrPlaneDetectorEXT handle in a PlaneDetectorEXT (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates PlaneDetectorEXT
 */
static OPENXR_HPP_INLINE XrPlaneDetectorEXT *put(PlaneDetectorEXT &h, bool clear = true) noexcept { return h.put(clear); }

//! @brief `<` comparison between PlaneDetectorEXT values.
//! @relates PlaneDetectorEXT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(PlaneDetectorEXT const& lhs, PlaneDetectorEXT const& rhs) noexcept {
    return lhs.get()<rhs.get();
}
//! @brief `>` comparison between PlaneDetectorEXT values.
//! @relates PlaneDetectorEXT
...
//! @relates PlaneDetectorEXT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(PlaneDetectorEXT const& lhs, XrPlaneDetectorEXT rhs) noexcept {
    return lhs.get()<rhs;
}
//! @brief `<` comparison between raw XrPlaneDetectorEXT and PlaneDetectorEXT.
//! @relates PlaneDetectorEXT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrPlaneDetectorEXT lhs, PlaneDetectorEXT const& rhs) noexcept {
    return lhs<rhs.get();
}
//! @brief `>` comparison between PlaneDetectorEXT and raw XrPlaneDetectorEXT.
//! @relates PlaneDetectorEXT
 ...
 * @relates PlaneDetectorEXT
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(PlaneDetectorEXT const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() == XR_NULL_HANDLE;
}
/*!
 ...
 * @relates PlaneDetectorEXT
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, PlaneDetectorEXT const &rhs) noexcept {
    return rhs.get() == XR_NULL_HANDLE;
}
/*!
 * @brief Inequality comparison between PlaneDetectorEXT and nullptr: true if the handle is not null.
 * @relates PlaneDetectorEXT
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator!=(PlaneDetectorEXT const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() != XR_NULL_HANDLE;
...
/*!
 * @brief Inequality comparison between nullptr and PlaneDetectorEXT: true if the handle is not null.
 * @relates PlaneDetectorEXT
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator!=(std::nullptr_t /* unused */, PlaneDetectorEXT const &rhs) noexcept {
    return rhs.get() != XR_NULL_HANDLE;
